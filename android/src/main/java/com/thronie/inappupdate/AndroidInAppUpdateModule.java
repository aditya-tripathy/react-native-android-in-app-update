...
public class AndroidInAppUpdateModule extends ReactContextBaseJavaModule
	...
	public AndroidInAppUpdateModule(ReactApplicationContext reactContext) {
		super(reactContext);
	...
	private void popupSnackbarForCompleteUpdate() {
		Snackbar snackbar = Snackbar.make(Objects.requireNonNull(reactContext.getCurrentActivity())
				.findViewById(android.R.id.content).getRootView(), "An update has just been downloaded.",
